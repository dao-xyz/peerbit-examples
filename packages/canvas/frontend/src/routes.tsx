...
export const getPathFromKey = (node: PublicSignKey, name: string) =>
    "k/" + base64url.encode(serialize(node)) + "/" + encodeURIComponent(name);
...
export const USER_BY_KEY_NAME = "/k/:key/:name";
