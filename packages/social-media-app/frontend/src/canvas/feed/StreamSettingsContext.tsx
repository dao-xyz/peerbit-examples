 ...
 */
export const StreamSettingsProvider: React.FC<{
    ...
    const createSettings = async (
        ...
        if (!program.program)
            throw new Error("StreamSettings program not ready");
    ...
    return (
        <StreamSettingsCtx.Provider value={value}>
            {children}
