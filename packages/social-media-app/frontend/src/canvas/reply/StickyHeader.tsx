...
export const StickyHeader = ({ children }) => {
    ...
    return (
        ...
        >
            ...
            <div
                className={`absolute inset-0 bg-white border-[#ccc] dark:border-[#6e6e6e82] border-t-[1px] border-b-[1px] dark:bg-[radial-gradient(circle,rgba(57,57,57,1)_0%,rgba(10,10,10,1)_100%)] drop-shadow-lg ${
