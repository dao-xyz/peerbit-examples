...
export const StickyHeader = ({
    ...
    collapsable?: boolean; // If true, the header will collapse when the main header is hidden.
    className?: string;
    ...
    return (
        <div
            ref={ref}
            className={
                `sticky  z-3 transition-transform duration-800 ease-in-out flex flex-row items-center justify-between` +
                (className ?? "")
            }
            style={{
